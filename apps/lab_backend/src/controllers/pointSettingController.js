...
const createSetting = async (req, res) => {
  try {
    const setting = await PointSetting.create(req.body);
...
const updateSetting = async (req, res) => {
  try {
    const setting = await PointSetting.update(req.params.id, req.body);
...
const deleteSetting = async (req, res) => {
  try {
    const success = await PointSetting.delete(req.params.id);
